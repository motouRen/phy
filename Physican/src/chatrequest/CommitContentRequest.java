...
public class CommitContentRequest {
	public static HttpHandler<String> receive(Context context,
			final Handler handler, Map<String, String> map, String contentJson) {
		final Message resultMsg = Message.obtain();
		RequestParams params = HeaderUtils.setHeader(map);
		params.addBodyParameter("contentJson", contentJson);
		HttpHandler<String> httpHandler = NetworkUtils.post(
				Urls.COMMITCONTENT_URL, params, new Handler() {
					@Override
