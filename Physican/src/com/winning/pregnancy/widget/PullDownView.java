...
import com.winning.pregnancy.widget.ScrollOverListView.OnScrollOverListener;
	...
	private Handler mUIHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case WHAT_DID_LOAD_DATA: {
				...
				mHeaderTextView.setText("下拉可以刷新");
				// mHeaderViewDateView = (TextView)
				// mHeaderView.findViewById(R.id.pulldown_header_date);
				// mHeaderViewDateView.setVisibility(View.VISIBLE);
				// mHeaderViewDateView.setText("更新于：" +
				// MyTimeUtil.DateToStr(MyTimeUtil.yyyy_MM_dd_HH_mm_ss, new
				// Date()));
