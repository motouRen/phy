...
public class SettingsFragment extends Fragment implements OnClickListener {
	...
	// protected JDTextView menuTitle;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		iv_switch_room_owner_leave_allow = (ImageView) getView().findViewById(
				R.id.iv_switch_chatroom_owner_leave_allow);
		iv_switch_room_owner_leave_disallow = (ImageView) getView()
				.findViewById(R.id.iv_switch_chatroom_owner_leave_not_allow);
		// rightIvMenu = (ImageView)
		// getView().findViewById(R.id.action_right_iv);
		// leftMenu = (ImageView) getView().findViewById(R.id.action_left_iv);
		// menuTitle = (JDTextView)
		// getView().findViewById(R.id.action_center_tv);
		// menuRight = (TextView) getView().findViewById(R.id.action_right_tv);
		// menuTitle.setText(getResources().getString(R.string.set));
	...
	public void onClick(View v) {
		...
		case R.id.rl_switch_chatroom_owner_leave:
			if (this.iv_switch_room_owner_leave_allow.getVisibility() == View.VISIBLE) {
				...
				iv_switch_room_owner_leave_allow.setVisibility(View.VISIBLE);
				iv_switch_room_owner_leave_disallow
