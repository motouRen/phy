...
public class OnsiteAdapter extends BaseAdapter {
	...
	public OnsiteAdapter(List<DoneDetail> list, Context mContext) {
		super();
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vh.textView_onsite_content.setText(list.get(position).getTitle());
		...
		switch (state) {
		case 1:
			vh.imageView_onsite_status.setImageResource(R.drawable.stop2);
			;
			break;
		case 2:
			vh.imageView_onsite_status.setImageResource(R.drawable.play2);
			break;
		case 3:
	...
	public void reloadAdapter(List<DoneDetail> data, boolean isClear) {
		if (isClear) {
			this.list.clear();
		}
