...
public class ClosedRequest {
	public static HttpHandler<String> close(Context context,
		...
		params.addBodyParameter("summary", summary);
		HttpHandler<String> httpHandler = NetworkUtils.post(Urls.CLOSE_URL,
				params, new Handler() {
					@Override
